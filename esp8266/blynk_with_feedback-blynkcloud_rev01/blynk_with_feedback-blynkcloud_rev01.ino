...
#define AUTH "6N6lD-d2jiw6GpGOhMXoEx94tPgHFL8k"  // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "TP-LINK_B0FF54"                   //Enter Wifi Name
#define WIFI_PASS "79959070"                   //Enter wifi Password

//#define SERVER "192.168.1.109"             // Comment-out if use Blynk hosted cloud service
#define PORT 8080
...
void setup()
{
  ...
  //Blynk.begin(AUTH, WIFI_SSID, WIFI_PASS,"192.168.1.109", 8080); //this for local server
